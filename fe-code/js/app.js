...
$loaderContainer=document.getElementById("loader-container"),$section1= document.getElementById("section1"),$section2= document.getElementById("section2"); 
...
function hidesection(){
 $section1.classList.add("sectionhide");
 $section2.classList.add("sectiondisplaynone");
}
